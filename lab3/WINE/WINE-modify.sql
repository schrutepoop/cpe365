...
update wine 
   set bestfrom = Year + 3,
       bestto = Year + 10
   where (Grape = 'Barbera' or Grape = 'Cabernet Frank' or Grape = 'Grenache' 
         or Grape = 'Malbec' or Grape = 'Merlot' or Grape = 'Mourvedre' 
         or Grape ='Petite Sirah' or Grape = 'Pinot Noir' 
         or Grape = 'Sangiovese' or Grape= 'Syrah' 
         or Grape = 'Tempranillo' or Grape = 'Zinfandel');
